  ...
  <div class="">
    <div class="container">
      ...
      <div class="login-page">
        ...
        <h4 class="user-register-heading text-center">Company Login</h4>
        <div class="row">
          @php
        ...
        <form class="form login-form" method="POST" action="{{ route('company/login') }}">
          ...
          <div class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
            <input id="email" type="username" class="form-control" name="username" value="{{ old('username') }}" placeholder="Enter Your Username" required autofocus>
